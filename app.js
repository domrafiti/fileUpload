...
app.post('/upload_photos', (req, res) => {
    console.log("Connetion Made", req.body); //currently req.body is undefined
    let photos = [];
    const form = formidable({ multiples: true, uploadDir: path.join(__dirname, '../tmp_uploads') });
...
app.listen(app.get('port'), function () {
    console.log('Express started at port http://localhost:' + app.get('port'));
});